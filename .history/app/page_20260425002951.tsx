                    ...
                    <div className="group relative grid pb-1 transition-all md:grid-cols-8 md:gap-4">
                      ...
                      <div className="z-10 md:col-span-6">
                        ...
                        <ul className="mt-2 space-y-1.5 text-sm leading-normal text-th-prose">
                          ...
                          <li className="flex gap-2.5"><span className="mt-2 h-1 w-1 shrink-0 rounded-full bg-th-accent"></span><span>Provided an easy UI/UX design for easy navigations, allowing for new users to easily </span></li>
                        </ul>
